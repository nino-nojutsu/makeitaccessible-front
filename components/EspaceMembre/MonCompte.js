            ...
            <div className={styles.layout}>
                ...
                <div className={styles.box}>
                    <div className={styles.field}>
                        <label>Nom</label>
                        <input type="text" placeholder="Modifier votre nom" onChange={(e) => setModifyLastName(e.target.value)} value={modifyLastName} className={styles.inputSignUp} />
                    </div>
                    <div className={styles.field}>
                        <label>Prénom</label>
                        <input type="text" placeholder="Modifier votre prénom" onChange={(e) => setModifyFirstName(e.target.value)} value={modifyFirstName} className={styles.inputSignUp} />
                    </div>
                    <div>
                        <label className={styles.field}>Email</label>
                        <input type="email" placeholder="Modifier votre email" onChange={(e) => setModifyEmail(e.target.value)} value={modifyEmail} className={styles.inputSignUp} />
                    </div>
                    <div>
                        <label className={styles.field}>Nom d'utilisateur</label>
                        <input type="text" placeholder="Modifier votre nom d'utilisateur" onChange={(e) => setModifyUsername(e.target.value)} value={modifyUsername} className={styles.inputSignUp} />
                    </div>
                    <div>
